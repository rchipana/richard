...
INSERT INTO `asociado` VALUES (1,'ALBERTO','SANCHEZ','PEREZ','MASCULINO','2015-07-02','2586639','87156974','JR SUAREZ  NRO 145','SANCHEZZ@HOTMAIL.COM',1,'NDAxMTk1ODk=','12457845564','40119589',NULL,NULL,1),(2,'SABINA','LAZARO','QUISPE','FEMENINO','2015-07-09','1258669','98569874','MI CASA','QUISPE@HOTMAIL.COM',6,'NTQ3ODU2MTI=','21457898654','54785612',NULL,NULL,1),(3,'ALEJANDRO','PEREZ','CARDENAS','MASCULINO','1988-03-04','2589336','98745621','AV JUAN ALMAGRO NRO 45897','CARDENAS@HOTMAIL.COM',12,'MjE1NDg3NDQ=','21457898654','21548744',NULL,NULL,1),(4,'JEN','QUISPE','YANQUI','FEMENINO','1989-07-08','2589969','98659870','AV CHIMU 451','QUISPE@HOTMAIL.COM',27,'MjM1Njg1NDQ=','65985632365','23568544',NULL,NULL,1),(5,'OSCAR','SUAREZ','SUAREZ','MASCULINO','1987-07-02','2569889','98535698','AV ANGAMOS 1564','SUAREZ@HOTMAIL.COM',23,'MTI2NTg5MzM=','12358963547','12658933',NULL,NULL,1),(6,'PRUEBA','PRUEBA','PRUEBA','MASCULINO','1985-08-06','','98748785','MI CASA','',2,'NDU3ODg3ODc=','','45788787',NULL,NULL,1),(7,'RTRR','RTTRT','RTRT','MASCULINO','2015-08-09','54545454','4554545445','GHGGHG','',8,'NDU0NTU0NTQ=','','45455454',NULL,NULL,0),(8,'TRRTTRTD','RTTRTR','RTRRTR','MASCULINO','2015-08-01','554545445','54784578','BCBCBCB','',7,'NTY1NjU2NTY=','','56565656',NULL,NULL,1);
...
INSERT INTO `cita_medica` VALUES (7,'2015-07-29 00:00:00','2015-07-29 02:00:00','DOLOR','1',1,1,3,1,NULL),(12,'2015-08-12 00:00:00','2015-07-31 03:00:00','sddssd','1',1,1,2,1,'04:00:00'),(13,'2015-08-12 00:00:00','2015-08-12 00:00:00','rerr','1',1,1,4,1,'02:00:00'),(14,'2015-08-13 00:00:00','2015-08-13 00:00:00','trrt','1',2,2,2,1,'03:00:00'),(15,'2015-08-14 00:00:00','2015-08-14 00:00:00','eer','1',4,4,2,1,'03:00:00'),(16,'2015-08-19 00:00:00','2015-08-18 00:00:00','sfsadgsa','1',1,1,2,1,'07:00:00'),(17,'2015-08-19 00:00:00','2015-08-19 00:00:00','ggsd','1',1,1,4,1,'03:00:00'),(18,'2015-08-12 05:00:00','2015-08-12 06:00:00','tryrt','1',1,1,3,1,'05:00:00'),(19,'2015-08-14 00:00:00','2015-08-14 00:00:00','jfg','1',1,1,2,1,'09:00:00');
...
CREATE TABLE `diagnostico` (
  ...
  `idCita_medica` int(11) DEFAULT NULL,
  ...
  `examen_cli` varchar(500) DEFAULT NULL,
...
INSERT INTO `diagnostico` VALUES (1,1,NULL,'2015-08-02','21','12','RICHARD CHIPANA AVENDAÑO','SI','DOLOR DE BARRIGA','ANALISIS DE ORINA Y ESES','ESTOMATITIS DIARREICA','NO','JARABE OSIS DOS CUCHARADAS DIARIAS DURANTE TODA LA SEMANA EN LA MAÑANA Y EN LA NOCHE',NULL,NULL);
...
CREATE TABLE `historia_clinica` (
  ...
  KEY `fk_Cita_medica_Mascota2_idx` (`idMascota`),
  KEY `fk_ID_ASOCIADO2` (`idAsociado`),
  CONSTRAINT `fk_Cita_medica_Mascota2` FOREIGN KEY (`idMascota`) REFERENCES `mascota` (`idMascota`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_ID_ASOCIADO2` FOREIGN KEY (`idAsociado`) REFERENCES `asociado` (`idAsociado`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
INSERT INTO `historia_clinica` VALUES (1,1,1,'2015-08-02','21','12','SI','SI',NULL,'LAVADO',NULL),(2,6,4,'2015-08-05','34','34','SI','NO',NULL,'SDSDS',NULL);
...
INSERT INTO `mascota` VALUES (1,'GRINGA','Rch_8f3ec26.jpg','2014-12-22','2015-07-25',1,0,NULL,1,NULL,1,1),(2,'RUFO','Rch_0822dfc.jpg','2015-01-20','2015-07-25',1,0,NULL,2,NULL,1,1),(3,'ELIAS','Rch_71db7df.jpg','2014-04-28','2015-07-27',1,0,NULL,3,NULL,1,1),(4,'GRINGA','Rch_378b1cf.jpg','2014-06-17','2015-07-27',0,0,NULL,4,NULL,1,1),(5,'LEON','Rch_a1c988c.jpg','2014-07-27','2015-07-27',1,0,NULL,1,NULL,1,1),(6,'LOBO','Rch_576bec6.jpg','2013-07-01','2015-07-27',1,0,NULL,4,NULL,1,1),(7,'PRUEBA PERRITO','Rch_e657f99.JPG','2006-08-01','2015-08-09',1,0,NULL,6,NULL,1,1),(8,'PONITONRR','Rch_1ba41e3.jpg','2006-08-03','2015-08-07',1,1,NULL,6,NULL,2,1);
...
-- Dump completed on 2015-08-11 23:31:44
