...
import richard.chipana.veterinaria.facade.TipoEmpleadoFacade;
...
public class TipoEmpleadoController implements Serializable {
    ...
    @EJB
    private richard.chipana.veterinaria.facade.TipoEmpleadoFacade ejbFacade;
    ...
    public void create() {
        persist(PersistAction.CREATE, ResourceBundle.getBundle("/Bundle").getString("TipoEmpleadoCreated"));
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("/Bundle").getString("TipoEmpleadoUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("/Bundle").getString("TipoEmpleadoDeleted"));
        if (!JsfUtil.isValidationFailed()) {
