...
import richard.chipana.veterinaria.facade.DistritoFacade;
...
@ManagedBean(name = "distritoController")
@SessionScoped
public class DistritoController implements Serializable {

    @EJB
    private richard.chipana.veterinaria.facade.DistritoFacade ejbFacade;
    ...
    public void create() {
        persist(PersistAction.CREATE, ResourceBundle.getBundle("/Bundle").getString("DistritoCreated"));
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("/Bundle").getString("DistritoUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("/Bundle").getString("DistritoDeleted"));
        if (!JsfUtil.isValidationFailed()) {
    ...
    public static class DistritoControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Distrito) {
                ...
                return getStringKey(o.getIdDistrito());
            } else {
